...
const Movie = () => {
    ...
    const backdropUrl = currentMovieDetail ? `https://image.tmdb.org/t/p/original${currentMovieDetail.backdrop_path || ''}` : '';
    ...
    return (
        <div className="movie">
            <div className="movie__intro">
                {backdropUrl && (
                    <img className="movie__backdrop" src={backdropUrl} alt={currentMovieDetail ? `${currentMovieDetail.original_title} backdrop` : 'Movie backdrop'} />
                )}
            </div>
            <div className="movie__detail">
                <div className="movie__detailLeft">
                    <div className="movie__posterBox">
                        {posterUrl && (
                            <img className="movie__poster" src={posterUrl} alt={currentMovieDetail ? `${currentMovieDetail.original_title} poster` : 'Movie poster'} />
                        )}
                    </div>
                </div>
